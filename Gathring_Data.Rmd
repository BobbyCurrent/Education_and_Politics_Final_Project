...
final_data <- full_join(spending_2004, spending_2008) %>%
  full_join(spending_2012) %>%
  full_join(spending_2016) %>%
  left_join(presidential_elections, by = c("conum" = "FIPS"))
...
read_csv("Raw_Data/non_fiscal_2012.csv") %>%
  clean_names() %>%
